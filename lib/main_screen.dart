    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: AppBarTheme(
          elevation: 5, // Slight elevation to add shadow
          ...
          IconButton(
            icon: Row(
              children: [
                Container(
                  decoration: BoxDecoration(
                    color: const Color.fromARGB(255, 100, 100, 100), // Gold background for Bitcoin icon
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: const Color.fromARGB(255, 255, 249, 249), // White text for coin amount
                          ),
                        ),
                      ],
                    ),
            ...
            DrawerHeader(
              ...
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    backgroundColor: Colors.white,
                    radius: 20, // Larger circle size for Drawer
                    child: Icon(
                      Icons.person,
                      color: Colors.teal,
                      size: 40, // Larger icon size for Drawer
                    ),
                  ),
                  SizedBox(height: 10),
                  Text(
